...
public class Scanner {
    ...
    /// The tokens found in the source code
    private final List<Token> tokens = new ArrayList<>();

    /// The first char of the current lexeme being scanned
    private int start = 0;
    /// The current char being scanned
    ...
    private void scanToken() {
        char c = advance();
        switch (c) {
            case '(': addToken(PAREN_OPEN); break;
            case ')': addToken(PAREN_CLOSE); break;
